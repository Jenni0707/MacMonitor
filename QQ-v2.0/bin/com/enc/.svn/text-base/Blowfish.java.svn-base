...
//		 String testString3 = crypt.encryptString(testString);
//		 System.out.println("加密之后**************\n"+"testString = "+testString3+" 加密后长度:"+testString3.length());
//		 
//		 System.out.println("开始解密");
//		 String testString2 = crypt.decryptString(testString1);
//		 System.out.println("解密之后**************\n"+"testString = "+testString2);
//		 String testString4 = crypt.decryptString(testString3);
